...
const AllListing = () => {
  return (
    <div className="mt-7 bg-white px-1 tab:px-3 py-1 tab:py-4 rounded-md flex tab:flex-col items-center gap-5 tab:gap-2 shadow-sm border">
      <div className="flex items-center tab:flex-col gap-1">
        <span className="text-sm tablet:text-xl font-semibold">
          See all listings
        </span>
        <FaLongArrowAltRight className="text-yellow-400 text-sm tablet:text-xl" />
      </div>

      <div className="flex items-center tab:flex-col gap-6 ">
