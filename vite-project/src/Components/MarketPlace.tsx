...
const MarketPlace = () => {
  return (
    <div className="sm:mt-4 bg-slate-50 py-8">
      ...
      <div className=" px-20 tab:px-5 gap-4 py-10">
        <div className="flex items-center justify-between  tab:flex-col tab:gap-5">
          ...
          <form className=" tab:w-full h-12 relative py-3 px-5 bg-slate-200 border border-slate-300 rounded-md tab:block">
            <input
              type="text"
              name="search"
              id="search"
        ...
        <div className="mt-8">
          <div className="grid grid-cols-3 gap-4 sm:flex sm:flex-col sm:gap-7 tab:grid-cols-2 ">
            <div className="rounded-md px-1 py-1">
              <img src={Cart_One} className="h-[120px] w-full" alt="" />
            ...
            <div className="rounded-md px-1 py-1">
              <img src={Cart_Two} className="h-[120px] w-full" alt="" />
            ...
            <div className="rounded-md px-1 py-1">
              <img src={Cart_Three} className="h-[120px] w-full" alt="" />
            ...
            <div className="rounded-md px-1 py-1">
              <img src={Cart_Four} className="h-[120px] w-full" alt="" />
            ...
            <div className="rounded-md px-1 py-1">
              <img src={Cart_Five} className="h-[120px] w-full" alt="" />
            ...
            <div className="rounded-md px-1 py-1">
              <img src={Cart_Six} className="h-[120px] w-full" alt="" />
          ...
          <div className="flex items-center justify-center mt-10">
            <Link
              className=" bg-blue-950 sm:w-full flex justify-center items-center rounded-md"
              to="/"
            >
              <button
